		...
		if (cmd.getName().equalsIgnoreCase("setgroup")) {
			...
			if (args.length == 2) {
				...
				if (grupo.equalsIgnoreCase("friend")) {
					...
					Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
							"pex user " + player.getName() + " group set Friend");
					player.kickPlayer(
				...
				if (sender.hasPermission("*"))
					if (grupo.equalsIgnoreCase("developer")) {
						p.sendMessage(
								"§aO jogador " + player.getName() + " §ateve o grupo alterado para §3[DEVELOPER]");
						Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
				...
				if (sender.hasPermission("*"))
					if (grupo.equalsIgnoreCase("subdono")) {
						...
						Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
								"pex user " + player.getName() + " group set SubDono");
						player.kickPlayer(
				...
				if (sender.hasPermission("*"))
					if (grupo.equalsIgnoreCase("dona")) {
						...
						Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
								"pex user " + player.getName() + " group set Dona");
						player.kickPlayer(
